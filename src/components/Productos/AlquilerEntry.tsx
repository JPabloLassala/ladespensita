...
export function AlquilerEntry({
  ...
  return (
    <div
      ...
      className="flex flex-col shrink-0 h-30 border p-4 rounded-xl shadow-md font-body hover:bg-slate-100 hover:cursor-pointer transition-colors duration-200"
